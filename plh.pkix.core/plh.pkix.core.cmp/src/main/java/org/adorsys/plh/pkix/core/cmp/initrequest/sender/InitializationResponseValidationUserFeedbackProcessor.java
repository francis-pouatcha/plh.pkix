...
public class InitializationResponseValidationUserFeedbackProcessor implements ActionProcessor{
	private final BuilderChecker checker = new BuilderChecker(InitializationResponseValidationUserFeedbackProcessor.class);
	@Override
	public void process(ActionContext actionContext) {
		...
		ASN1Action nextAction = new ASN1Action(
			...
			new DERIA5String(InitializationResponseValidationUserFeedbackPostAction.class.getName()));
