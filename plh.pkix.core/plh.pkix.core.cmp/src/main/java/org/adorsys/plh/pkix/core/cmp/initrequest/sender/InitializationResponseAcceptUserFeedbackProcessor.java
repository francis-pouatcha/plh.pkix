...
public class InitializationResponseAcceptUserFeedbackProcessor implements ActionProcessor{
	private final BuilderChecker checker = new BuilderChecker(InitializationResponseAcceptUserFeedbackProcessor.class);
	...
	public void process(ActionContext actionContext) {
		...
		ASN1Action nextAction = new ASN1Action(
			...
			new DERIA5String(InitializationResponseAcceptUserFeedbackPostAction.class.getName()));
