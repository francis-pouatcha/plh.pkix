...
public class CertReqResponseSendActionProcessor implements ActionProcessor {

	private final BuilderChecker checker = new BuilderChecker(CertReqResponseSendActionProcessor.class);
