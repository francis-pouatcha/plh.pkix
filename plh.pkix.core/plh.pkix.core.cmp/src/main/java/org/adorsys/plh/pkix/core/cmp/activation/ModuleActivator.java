...
public abstract class ModuleActivator {
	...
	public ModuleActivator(ActionContext accountContext, FileWrapper accountDir, ModuleActivators moduleActivators) {
		Integer incomingMessageType = getIncomingMessageType();
		if(incomingMessageType!=null)moduleActivators.addActivator(this);
