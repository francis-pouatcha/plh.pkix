...
public class CertReqValidationUserFeedbackProcessor implements ActionProcessor{
	private final BuilderChecker checker = new BuilderChecker(CertReqValidationUserFeedbackProcessor.class);
	...
	public void process(ActionContext actionContext) {
		...
		ASN1Action nextAction = new ASN1Action(
			...
			new DERIA5String(CertReqValidationUserFeedbackPostAction.class.getName()));
