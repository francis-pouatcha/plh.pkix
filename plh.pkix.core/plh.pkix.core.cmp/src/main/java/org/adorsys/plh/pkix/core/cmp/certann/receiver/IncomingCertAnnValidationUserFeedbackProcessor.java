...
public class IncomingCertAnnValidationUserFeedbackProcessor implements ActionProcessor{
	private final BuilderChecker checker = new BuilderChecker(IncomingCertAnnValidationUserFeedbackProcessor.class);
	...
	public void process(ActionContext actionContext) {
		...
		ASN1Action nextAction = new ASN1Action(
			...
			new DERIA5String(IncomingCertAnnValidationUserFeedbackPostAction.class.getName()));
