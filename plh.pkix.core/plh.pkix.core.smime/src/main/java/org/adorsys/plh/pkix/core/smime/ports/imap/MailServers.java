...
public enum MailServers {
	...
	ADORSYS_COM("adorsys.com", "mail.adorsys.com", "465", "mail.adorsys.com", "993"), 
	AOL("aol.com", "smtp.aol.com", "465", "imap.aol.com", "993"), 
	BELLSOUTH("bellsouth.net", "smtp.bellsouth.net", "465", "mail.bellsouth.net","993"), 
	CURRYSIMPLE("currysimple.com", "smtp.currysimple.com","465", "imap.currysimple.com", "993"), 
	GACCSOUTH("gaccsouth.com","smtp.gaccsouth.com", "465", "mail.gaccsouth.com", "993"), 
	GERMANHEALTHPLANS(
			"germanhealthplans.com", "smtp.germanhealthplans.com", "465",
			"imap.germanhealthplans.com", "993"), 
	GMX_DE("gmx.de",
			"mail.gmx.de", "465", "imap.gmx.de", "993"), 
	GMX_COM("gmx.com",
			"mail.gmx.com", "465", "imap.gmx.com", "993"), 
	GMAIL("gmail.com",
	...
	HOTMAIL("hotmail.com",
			"smtp.hotmail.com", "465", "mail.hotmail.com", "993"), 
	MSN(
			"msn.com", "smtp.msn.com", "465", "mail.msn.com", "993"), 
	PARAMOUNTFINANCIALGRP(
			"paramountfinancialgrp.com", "smtp.paramountfinancialgrp", "465",
			"imap.paramountfinancialgrp.com", "993"), 
	SIMPAQ("simpaq.com",
			"smtp.simpaq", "465", "imap.simpaq.com", "993"), 
	WEB_DE("web.de",
			"smtp.web.de", "465", "imap.web.de", "993"), 
	YAHOO("yahoo.com",
			"smtp.mail.yahoo.com", "465", "imap.mail.yahoo.com", "993"), 
	YAHOOFR(
	...
	private MailServers(String serverName, String smtpServerAddr,
	...
	public static void preprocessMailAccount(final EmailAccountData emailAccount)
		...
		MailServers server = null;
		MailServers[] values = MailServers.values();
		for (MailServers imapServer : values) {
...
//			Throwable cause = e.getCause();
//			if (cause != null && cause instanceof UnknownHostException) {
//				emailAccount.get (UnknownHostException.class.getName());
//				return false;
//			}
//			if (cause != null && cause instanceof SSLHandshakeException) {
//				return false;
