...
public class GeneralCertValidator {
	...
	public GeneralCertValidator validate(Date signTime) {
		...
		try {
			...
			throw new PlhUncheckedException(cpre.getErrorMessage());
		}
		return this;
	}
	...
	public GeneralCertValidator withCert(X509Certificate cert) {
		this.cert = cert;
		return this;
	}
